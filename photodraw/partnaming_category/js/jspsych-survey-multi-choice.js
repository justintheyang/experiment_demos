...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      // add question text
      pointer_style = trial.comprehension ? ' ' : 'cursor: pointer'
      html += '<p class="jspsych-survey-multi-choice-text survey-multi-choice" style=' + pointer_style + '>' + question.prompt 
