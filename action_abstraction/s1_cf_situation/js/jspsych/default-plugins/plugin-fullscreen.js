  ...
  const info = {
      ...
      parameters: {
          ...
          message: {
              ...
              pretty_name: "Message",
              default: "<p>The experiment will switch to fullscreen when you press the button below.</p>\
                        <p>Please remain in fullscreen for the duration of the experiment, otherwise certain features will not work correctly.</p>",
              array: false,
          },
